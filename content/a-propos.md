...
<div style="border-left:2px solid #00c97a;padding-left:1.5rem;margin:1.5rem 0">
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:.75rem;margin:1.2rem 0">

<div style="padding:1rem;border:1px solid var(--bs-border-color);border-radius:.5rem;font-size:.9rem">
<strong>Normes</strong><br/>ISO 27001 · ISO 27002 · ISO 27005 · TISAX
</div>

<div style="padding:1rem;border:1px solid var(--bs-border-color);border-radius:.5rem;font-size:.9rem">
<strong>Méthodes risques</strong><br/>EBIOS Risk Manager · NIST CSF
</div>

<div style="padding:1rem;border:1px solid var(--bs-border-color);border-radius:.5rem;font-size:.9rem">
<strong>Réglementaire</strong><br/>RGPD · ANSSI (II1300 · II901) · ETG
</div>

<div style="padding:1rem;border:1px solid var(--bs-border-color);border-radius:.5rem;font-size:.9rem">
<strong>Langues</strong><br/>Français · Anglais C1 · Espagnol B2
</div>
