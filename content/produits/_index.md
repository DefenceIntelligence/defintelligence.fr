...
<div style="padding:2rem 2rem 1.5rem;background:rgba(0,201,122,.05);border-bottom:1px solid var(--bs-border-color)">
...
<div style="padding:.9rem 1rem;border:1px solid var(--bs-border-color);border-radius:.5rem">
<p style="margin:0 0 .2rem;font-weight:700;font-size:.9rem">🛰️ CTI intégré</p>
<p style="margin:0;font-size:.82rem;color:var(--bs-secondary-color)">Ransomware, credentials leaks, brand monitor.</p>
</div>
